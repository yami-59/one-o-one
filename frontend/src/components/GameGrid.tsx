...
export default function GameGrid({ grid, selection }: Props) {
  return (
    <div className="bg-gray-800 p-3 rounded-xl border border-gray-700 shadow-2xl">
      <div 
      ...
      >
        {grid.flat().map((char, i) => {
          ...
          let bgClass = "bg-gray-700/50 hover:bg-gray-700 text-gray-300";
          ...
          return (
            <div 
              key={i}
              className={`
                ${bgClass} aspect-square flex items-center justify-center 
