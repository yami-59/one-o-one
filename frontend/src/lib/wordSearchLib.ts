...
/**
 * Convertit les coordonnées pixel (relatives au Canvas) en index de grille (Ligne, Colonne).
...
export const getRandomLetter = () => 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'[Math.floor(Math.random() * 26)];
